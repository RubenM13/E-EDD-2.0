...
import es.ucm.fdi.edd.ui.views.IGraphvizView;

public class Save2FileCommand extends AbstractHandler {
	...
	private IGraphvizView view;

	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		IWorkbenchPart activePart = HandlerUtil.getActivePart(event);
		if (activePart instanceof IGraphvizView) {
			this.view = (IGraphvizView) activePart;
